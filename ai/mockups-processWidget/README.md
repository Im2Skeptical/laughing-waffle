...
ProcessWidget_Expanded_01.png
- this shows the ability to expand to show routing toggles for input and ouput if available. Please note the pill behavior is intended to mostly match tag pill behaviour, the player can drag to order priority or toggle them on and off

ProcessWidget_Variations_01.png
- this shows some rough variations for different modes that the process widget will ultimately need to support in some fashion.